  ...
  return (
    <section className="relative py-16 overflow-hidden text-center md:py-20 bg-white">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/images/1hourspecs_header4.jpg"
          alt="abstract design background"
          className="w-full h-full object-cover opacity-100" // Keep original image opacity here
        />
        {/* GRADIENT OVERLAY */}
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(255,255,255,0) 100%, rgba(255,255,255,0.7) 100%, rgba(255,255,255,1) 100%)",
          }}
        ></div>
      ...
      <motion.div
        ...
        className="relative z-10 max-w-3xl mx-auto px-8 text-gray-100 "
      >
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-[clamp(2.5rem,5vw,6rem)] font-extrabold mb-4"
        >
          Welcome to 1 Hour Spectacle and Watch Repairs
        </motion.h1>
        <p className="text-[clamp(1rem,2vw,1.25rem)] leading-relaxed mt-4 text-gray-100">
